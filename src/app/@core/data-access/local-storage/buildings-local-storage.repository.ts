...
export class BuildingsLocalStorageRepository implements BuildingsRepository {
  ...
  create(dto: CreateBuildingDto): Observable<Building> {
    ...
    const newBuilding: Building = {
      ...
      guardRoomCount: dto.guardRoomCount,
      rooftopCount: dto.rooftopCount,
      servicedApartmentCount: dto.servicedApartmentCount,
      mapLink: dto.mapLink,
      waterMeterNumber: dto.waterMeterNumber,
      buildingLicenseUrl: dto.buildingLicenseUrl,
      buildingPlanUrl: dto.buildingPlanUrl,
      realEstateAuthorityDeedUrl: dto.realEstateAuthorityDeedUrl,
      otherDocumentUrls: dto.otherDocumentUrls || [],
      ownerManagerName: dto.ownerManagerName,
      renterManagerIds: dto.renterManagerIds || [],
      electricityMeters: dto.electricityMeters || [],
